    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div className="space-y-4">
                ...
                <Card shadowColor={yellowAccent} bg="#000" className="p-6 md:p-8 space-y-4 italic font-bold text-xs md:text-sm border-2 text-white" style={{ borderColor: yellowAccent }}>
