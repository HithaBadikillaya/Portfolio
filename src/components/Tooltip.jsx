    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/hitha-badikillaya/" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/HithaBadikillaya" aria-label="GitHub" data-social="github">
            <div className="filled" />
...
const StyledWrapper = styled.div`
  ...
  a[data-social="linkedin"] ~ .tooltip {
